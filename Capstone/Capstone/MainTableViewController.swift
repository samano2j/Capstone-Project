...
class MainTableViewController: BaseTableViewController {
    ...
    let Products = [
        ...
        Product(title: Product.ProductKind.Aconitum, yearIntroduced: 2007, introPrice: 49.98),
        Product(title: Product.ProductKind.Alstroemeria, yearIntroduced: 2001, introPrice: 51.99),
        Product(title: Product.ProductKind.Ranunculus, yearIntroduced: 2007, introPrice: 16.99),
        Product(title: Product.ProductKind.Bethlehem, yearIntroduced: 2010, introPrice: 31.99),
        Product(title: Product.ProductKind.Hypericum, yearIntroduced: 2010, introPrice: 24.99),
        Product(title: Product.ProductKind.Lisianthus, yearIntroduced: 2012, introPrice: 24.99),
        Product(title: Product.ProductKind.Scabiosa, yearIntroduced: 1997, introPrice: 39.99),
        Product(title: Product.ProductKind.Tropicals, yearIntroduced: 2006, introPrice: 23.99),
        Product(title: Product.ProductKind.Baneberry, yearIntroduced: 2008, introPrice: 25.00),
        Product(title: Product.ProductKind.Begonia, yearIntroduced: 2006, introPrice: 25.00),
        Product(title: Product.ProductKind.Bloodroot, yearIntroduced: 2010, introPrice: 24.99),
        Product(title: Product.ProductKind.BleedingHeart, yearIntroduced: 2012, introPrice: 24.99),
        Product(title: Product.ProductKind.Caladium, yearIntroduced: 1997, introPrice: 39.99),
        Product(title: Product.ProductKind.CardinalFlower, yearIntroduced: 2006, introPrice: 23.99),
        Product(title: Product.ProductKind.Malva, yearIntroduced: 2008, introPrice: 25.00),
        Product(title: Product.ProductKind.Lupine, yearIntroduced: 2006, introPrice: 25.00),
        Product(title: Product.ProductKind.Pointdexter, yearIntroduced: 2013, introPrice: 29.34)
    ]
    ...
    private static let viewControllerIdentifier = "MainTableViewController"
    ...
    class func mainViewControllerForMail(_ mail: String) -> UIViewController {
        let storyboard = UIStoryboard(name: MainTableViewController.storyboardName, bundle: nil)
        
        let viewController =
            storyboard.instantiateViewController(withIdentifier: MainTableViewController.viewControllerIdentifier)
        
        if let mainViewController = viewController as? MainTableViewController {
            mainViewController.mail = mail
        }
