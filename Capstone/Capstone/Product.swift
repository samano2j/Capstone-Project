...
class Product: NSObject, NSCoding {
    ...
    struct ProductKind {
        ...
        static let Aconitum = "Aconitum"
        static let Alstroemeria = "Alstroemeria"
        static let Ranunculus = "Ranunculus"
        static let Bethlehem = "Bethlehem"
        static let Hypericum = "Hypericum"
        static let Lisianthus = "Lisianthus"
        static let Scabiosa = "Scabiosa"
        static let Tropicals = "Tropicals"
        static let Baneberry = "Baneberry"
        static let Begonia = "Begonia"
        static let Bloodroot = "Bloodroot"
        static let BleedingHeart = "Bleeding Heart"
        static let Caladium = "Caladium"
        static let CardinalFlower = "Cardinal Flower"
        static let Malva = "Malva"
        static let Lupine = "Lupine"
        static let Pointdexter = "Pointdexter"
    }
